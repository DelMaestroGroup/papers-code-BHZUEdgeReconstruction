...
set ylabel rotate by 0 '\scalebox{1.4}{$\frac{\omega}{m}$}' offset 12.2,0

set ytics ('\fontsize{9}{9} $-0.2$' -0.2, '\fontsize{9}{9} $-0.4$' -0.4, '\fontsize{9}{9} \raisebox{0.5ex}{$-0.6$}' -0.6, '\fontsize{9}{9} $0.0$' 0.0, '\fontsize{9}{9} $0.2$' 0.2, '\fontsize{9}{9} $0.4$' 0.4, '\fontsize{9}{9} \raisebox{-0.5ex}{$0.6$}' 0.6) offset 1.4,0 
...
set ylabel rotate by 0 '\scalebox{1.4}{$\frac{\omega}{m}$}' offset 12.2,0
set xlabel '\fontsize{12}{12} $k_y a$' offset 0.1,1.1

set ytics ('\fontsize{9}{9} $-0.2$' -0.2, '\fontsize{9}{9} $-0.4$' -0.4, '\fontsize{9}{9} \raisebox{0.5ex}{$-0.6$}' -0.6, '\fontsize{9}{9} $0.0$' 0.0, '\fontsize{9}{9} $0.2$' 0.2, '\fontsize{9}{9} $0.4$' 0.4, '\fontsize{9}{9} \raisebox{-0.5ex}{$0.6$}' 0.6) offset 1.4,0.0
set xtics ('\fontsize{9}{9} \hspace{0.1em}$-\pi$' -1.0*pi, '\fontsize{9}{9} $-\pi/2$' -0.5*pi, '\fontsize{9}{9} $0$' 0.0, '\fontsize{9}{9} $\pi/2$' 0.5*pi, '\fontsize{9}{9}\hspace{-0.5em}$\pi$' 1.0*pi) offset -0.25,0.75
