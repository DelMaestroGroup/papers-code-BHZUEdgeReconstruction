...
plot f(x) w l lt 1 lw 3 dt 3 lc rgb 'black' ti 'fit', "../../data/SpinSplitting_vs_Lx.txt" u (1.0)/($1):(2.0*$2) w lp lw 4 lt 1 pt 1 ps 1.5 lc rgb '#2e86c1' ti 'data'
