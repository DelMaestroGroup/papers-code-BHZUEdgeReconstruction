...
set xlabel '\scalebox{1.1}{$k_y a$}' offset 0.0,1.5
set xtics ('\fontsize{7}{7} \hspace{0.1em}$-\pi$' -1.0*pi, '\fontsize{7}{7} $-\pi/2$' -0.5*pi, '\fontsize{7}{7} $0$' 0.0, '\fontsize{7}{7} $\pi/2$' 0.5*pi, '\fontsize{7}{7} \hspace{-0.6em}$\pi$' 1.0*pi) offset -0.2,0.95
...
set ylabel rotate by 0 '\scalebox{1.1}{$\frac{\omega}{m}$}' offset 12.7,0

set ytics ('\fontsize{7}{7} $-0.2$' -0.2, '\fontsize{7}{7} $-0.4$' -0.4, '\fontsize{7}{7}\raisebox{0.5ex}{$-0.6$}' -0.6, '\fontsize{7}{7} $0.0$' 0.0, '\fontsize{7}{7} $0.2$' 0.2, '\fontsize{7}{7} $0.4$' 0.4, '\fontsize{7}{7} \raisebox{-0.5ex}{$0.6$}' 0.6) offset 1.4,0 
