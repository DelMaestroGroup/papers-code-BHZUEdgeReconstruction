...
set label 1 '\scalebox{1.0}{(a)} \scalebox{0.8}{$N_0$, $S^z_{\mathrm{tot}}=0$}' at 0.1,0.24

plot "../../data/Sz_rx_yavg_Nup27_Ndn27_L12_W03_V4.60_Sz0.0.txt" u (($1)-1.0):2 w lp ps 0.9 pt 7 lw 2.5 lt 1 lc rgb '#cb4335' ti '\fontsize{7}{7} $\alpha=s$', "" u (($1)-1.0):3 w lp ps 0.9 pt 5 lw 2.5 lt 1 lc rgb '#2e86c1' ti '\fontsize{7}{7} $\alpha=p$'
...
set label 1 '\scalebox{1.0}{(b)} \scalebox{0.8}{$N_0+1$, $S^z_{\mathrm{tot}}=1/2$}' at 0.1,0.24

plot "../../data/Sz_rx_yavg_Nup28_Ndn27_L12_W03_V4.20_Sz0.5.txt" u (($1)-1.0):2 w lp ps 0.9 pt 7 lw 2.5 lt 1 lc rgb '#cb4335' ti '', "" u (($1)-1.0):3 w lp ps 0.9 pt 5 lw 2.5 lt 1 lc rgb '#2e86c1' ti ''
...
set label 1 '\scalebox{1.0}{(c)} \scalebox{0.8}{$N_0+2$, $S^z_{\mathrm{tot}}=1$}' at 0.1,0.24

plot "../../data/Sz_rx_yavg_Nup29_Ndn27_L12_W03_V4.00_Sz1.0.txt" u (($1)-1.0):2 w lp ps 0.9 pt 7 lw 2.5 lt 1 lc rgb '#cb4335' ti '', "" u (($1)-1.0):3 w lp ps 0.9 pt 5 lw 2.5 lt 1 lc rgb '#2e86c1' ti ''
